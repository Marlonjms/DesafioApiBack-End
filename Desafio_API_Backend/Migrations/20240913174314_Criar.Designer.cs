...
namespace Desafio_API_Backend.Migrations
{
    ...
    [Migration("20240913174314_Criar")]
    partial class Criar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Desafio_API_Backend.Modelos.ModeloLocaçao", b =>
                {
                    b.Property<int>("Id")
            ...
            modelBuilder.Entity("Desafio_API_Backend.Modelos.ModeloMoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Desafio_API_Backend.Modelos.ModeloLocaçao", b =>
                {
                    b.HasOne("Desafio_API_Backend.Modelos.ModeloMoto", "MotoRelacionada")
                        .WithMany("Alocacoes")
